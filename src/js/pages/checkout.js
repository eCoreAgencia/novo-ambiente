$(document).ready(function () {
	$(window).on('orderFormUpdated.vtex', function (evt, orderForm) {
		setTimeout(() => {
			$('tr.item-unavailable span, .unavailable-message p').html(
				'<style>' +
				' .item-unavailable, .unavailable-message p{font-size: 12px !important;font-weigth: unset !important;padding-left:6px;}' +
				'</style>' +
